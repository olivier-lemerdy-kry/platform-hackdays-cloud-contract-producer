...
import se.kry.demo.contract.producer.domain.FraudCheckRequest;
import se.kry.demo.contract.producer.domain.FraudCheckResponse;
import se.kry.demo.contract.producer.domain.FraudCheckStatus;
